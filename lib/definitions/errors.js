...
export function EINVALIDNGPACKAGEFILEPATH({ ngPackageFilePath }) {
  return {
    message: "Invalid `ngPackageFilePath` option.",
    details: `The [ngPackageFilePath option](https://github.com/ng-packagr/ng-packagr#usage-example) option, must be a \`String\`.

Your configuration for the \`ngPackageFilePath\` option is \`${ngPackageFilePath}\`.`,
  };
}
...
export function ENONGPACKAGEJSON() {
  return {
    message: "Missing `ng-package.json` file.",
    details: `A [ng-package.json file](https://github.com/ng-packagr/ng-packagr#usage-example) at the root of your project is required to ng-packagr.`
  }
}
